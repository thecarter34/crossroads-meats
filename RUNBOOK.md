...
> **Status:** Maintenance
> **Next:** Two GBP posts LIVE: (1) free t-shirt giveaway (post id 7494464812631420451), (2) brand-style grand opening poster (post id 4700139011320040348). Both assets deployed to dev (commits 9c169b1, 956e31b) — needs ship-it to prd before sourceUrls become permanent on apex.
> **Blocker:** None on posts (both live). Background: Dennis screen-share still open (Q&A/hours/serviceItems) — didn't block these announcements because grand opening is public-time-sensitive, distinct from routine GBP edits.
...
| 1a | **Ship gbp-grand-opening-shirt.jpg + gbp-grand-opening-poster.jpg to prd** | Both GBP post sourceUrls point to dev.crossroads-meats.pages.dev (24h TTL). Re-pushing to prd makes sourceUrls permanent on apex. | 🟡 awaiting ship-it | Low |
