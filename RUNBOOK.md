...
> **Status:** Maintenance
> **Next:** GBP grand opening post LIVE (free t-shirt giveaway, Sat Jul 18 10AM–6PM, post id 7494464812631420451, displayed through Jul 19). Asset deployed to dev (commit 9c169b1) — needs ship-it to prd before post sourceUrl can become permanent on apex.
> **Blocker:** None on the post (it's live). Background: Dennis screen-share still open (Q&A/hours/serviceItems) — didn't block this announcement because grand opening is a public-time-sensitive promo, not a routine GBP edit.
...
| 1a | **Ship gbp-grand-opening-shirt.jpg asset to prd** | The grand opening post sourceUrl points to dev.crossroads-meats.pages.dev (24h TTL). Re-pushing to prd makes sourceUrl permanent on apex. | 🟡 awaiting ship-it | Low |
